...
class Signing(db.Model):
    ...
    timestamp_human_readable = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
    expiration_human_readable = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
